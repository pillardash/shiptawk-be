...
from app.modules.evidence.policies.access import can_create_evidence, can_review_evidence
from app.modules.evidence.repositories.evidence import get_latest_review
...
async def create_evidence(
    ...
    if not can_create_evidence(role):
